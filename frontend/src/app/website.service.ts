...
export class WebsiteService {
  ...
  private websitesUrl = 'http://localhost:3000/api/websites'; 
  private pagesUrl = 'http://localhost:3000/api/pages'; 
  private websiteUrl = 'http://localhost:3000/api/website'; 
  private pageUrl = 'http://localhost:3000/api/page'
